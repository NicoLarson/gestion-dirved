    ...
    <Router>
      ...
      <div className="display">
        <Routes>
          ...
          <Route path="/show/conventions/category" element={<ShowConventionsCountCategory />} />
          <Route path="/show/conventionsbycategory/:category" element={<ShowConventionsByCategory />} />
          <Route path="/show/convention/:id" element={<ShowConventionDetail />} />
