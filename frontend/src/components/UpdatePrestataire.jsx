...
export default function UpdatePrestataire() {
  ...
  async function onSubmit(e) {
    ...
    await fetch(`http://localhost:5000/update/prestataire/${params.id}`, {
      method: 'POST',
      ...
      <fieldset className="form-group">
        ...
        <form onSubmit={onSubmit} method="post" encType="multipart/form-data">
          <div className="form-group">
            <label className="label" htmlFor="pre_nom">
              Nom
            </label>
            <input
          ...
          <div className="form-group">
            <label className="label" htmlFor="pre_type">
              Type
            </label>
            <input
              className="input input-bordered input-sm w-full max-w-xs"
          ...
          <div className="form-group">
            <label className="label" htmlFor="pre_adresse">
              Adresse
            </label>
            <input
              className="input input-bordered input-sm w-full max-w-xs"
          ...
          <div className="form-group">
            <label className="label" htmlFor="pre_telephone">
              Telephone
            </label>
            <input
              className="input input-bordered input-sm w-full max-w-xs"
          ...
          <div className="form-group">
            <label className="label" htmlFor="pre_email">
              Email
            </label>
            <input
              className="input input-bordered input-sm w-full max-w-xs"
          ...
          <div className="form-group">
            <label className="label" htmlFor="pre_rib">
              RIB
            </label>
          ...
          <div className="form-group">
            <label className="label" htmlFor="pre_kbis">
              KBIS
            </label>
