...
const Convention = (props) => (
    <tr>
        ...
        <td className="max-w-xs overflow-hidden hover:overflow-auto">{props.convention.con_nom_operation}</td>
        ...
        <td>
            <Link className="btn btn-primary btn-outline btn-xs" to={`/show/convention/${props.convention._id}`}>Detail</Link>
        </td>
        <td>
