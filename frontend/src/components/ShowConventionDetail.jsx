    ...
    return (
        ...
        <div className="card w-96 bg-base-100 shadow-xl">
            <div className="card-body">
                ...
                <p className="card-title">Montant encaissée: {product.con_montant_encaisse}</p>
                <p className="card-title">Pieces jointes: {product.con_piece_jointes}</p>
                <p className="card-title">Catégorie: {product.con_categories}</p>
                <p className="card-title">Partenaires: {product.con_partenaires}</p>
                <p className="card-title">Dernière mise à jour: {product.con_date_mise_a_jour}</p>
                ...
                <Link className="btn btn-warning btn-outline" to={`/show/conventions`}>Retour</Link>
                </div>
            </div>
        </div>
    );
